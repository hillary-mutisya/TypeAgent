...
import { EntityMockDataGenerator, MOCK_SCENARIOS } from '../../src/agent/knowledge/mockEntityData.mjs';
...
describe('EntityMockDataGenerator', () => {
    ...
    test('should generate relationships with proper structure', async () => {
        ...
        const allRelationships = Array.from(graph.relationships.values()).flat();
